          ...
          <div className="space-y-3 pb-20">
            <SectionCard title="经营规则">
              <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
                {[
                  {
                    key: "needPick" as const,
                    label: "是否需要拣货",
                  },
                  {
                    key: "needPack" as const,
                    label: "是否需要打包",
                  },
                  {
                    key: "needDelivery" as const,
                    label: "是否需要发货",
                  },
                ].map(({ key, label }) => (
                  <div
            ...
            <SectionCard title="客户欠款超期未结开单方式">
              <div className="space-y-3">
                  ...
                  {OVERDUE_OPTIONS.map((opt) => (
                    ...
                    >
                      <input
                        ...
                        value={opt.value}
                        checked={
                          config.overdueAction === opt.value
                        }
                        onChange={() =>
                          set("overdueAction", opt.value)
                        }
                        className="text-blue-500 focus:ring-blue-200"
                      />
                      <span className="text-sm text-gray-700">
                ...
                <div className="grid grid-cols-[88px_1fr] items-start gap-3">
                  <div className="pt-2 text-sm text-gray-900">
                    逾期开单消息接收人
                  </div>
              ...
              <div className="space-y-3">
                <div>
                  <div className="grid grid-cols-[88px_1fr_30px_1fr] items-center gap-3">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        set("workStartTime", e.target.value)
                      }
                      aria-label="开始时间"
                      title="开始时间"
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        set("workEndTime", e.target.value)
                      }
                      aria-label="结束时间"
                      title="结束时间"
                      className="h-10 rounded-sm border border-gray-300 px-3 text-sm focus:border-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-100"
                ...
                <div className="grid grid-cols-[88px_1fr] items-start gap-3">
                  ...
                  <RadioGroup
                    ...
                    onChange={(v) =>
                      set("mallOrderOutsideWork", v as boolean)
                    }
                  />
                </div>
              </div>
            ...
            <SectionCard title="商品条码">
              <div className="grid grid-cols-[88px_1fr_1fr] items-center gap-3">
                ...
                <input
                  ...
                  onChange={(e) =>
                    set("barcodePrefix", e.target.value)
                  }
                  placeholder="SP"
                ...
                <input
                  ...
                  onChange={(e) =>
                    set("barcodeLength", Number(e.target.value))
                  }
                  className="h-10 rounded-sm border border-gray-300 px-3 text-sm focus:border-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-100"
                />
              </div>
            ...
            <SectionCard title="导入审核">
              <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
                {[
                  {
                    key: "partImportReview" as const,
                    label: "配件导入审核",
                  },
                  {
                    key: "purchaseImportReview" as const,
                    label: "采购导入审核",
                  },
                ].map(({ key, label }) => (
                  <div
